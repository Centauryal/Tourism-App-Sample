...
class FavoriteFragment : Fragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        (requireActivity().application as TourismApp).appComponent.inject(this)
    }
